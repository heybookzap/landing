    ...
    <main className="min-h-screen bg-[#050505] text-white flex flex-col items-center px-6 font-pretendard relative overflow-y-auto selection:bg-[#C2A35D] selection:text-black">
      ...
      <header className="w-full px-4 md:px-8 py-10 z-40 flex justify-between items-center max-w-6xl mx-auto">
        <div className="flex items-center gap-3">
          <div className="bg-[#C2A35D] w-[18px] h-[18px] rounded-full flex items-center justify-center text-black text-[8px] font-bold">1B</div>
          <span className="text-[#C2A35D] text-[9px] tracking-[0.4em] font-medium uppercase">ONE BLANK</span>
        </div>
      ...
      <div className="w-full max-w-5xl mx-auto z-10 pb-32">
        ...
        >
          <p className="text-[#C2A35D] text-[10px] tracking-[0.5em] font-medium mb-8 uppercase">우리가 하는 일</p>
          ...
          <div className="w-[1px] h-12 bg-zinc-800 mx-auto mb-8"></div>
        ...
        >
          <div className="text-center mb-16">
            <p className="text-[#C2A35D] text-[10px] tracking-[0.5em] font-medium uppercase">어떻게 돕나요?</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            {[
              ...
              <motion.div 
                ...
                className="bg-white/[0.01] border border-white/5 backdrop-blur-md p-8 md:p-12 rounded-3xl flex flex-col justify-between shadow-[0_20px_40px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.05)] transition-all duration-500 group"
              >
        ...
        >
          <button 
            ...
            className="w-full max-w-[340px] py-6 bg-white text-black text-[11px] tracking-[0.3em] font-bold rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_20px_40px_rgba(194,163,93,0.4),inset_0_1px_0_rgba(255,255,255,0.5)] hover:bg-[#C2A35D] transition-all duration-500 uppercase"
          >
            이해했습니다. 고민 모두 넘기기
          </button>
        </motion.div>
